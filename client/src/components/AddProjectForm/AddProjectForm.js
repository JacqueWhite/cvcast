...
function UploadInstructions(props) {
  const isEditing = props.isEditing;
    if (isEditing) {
      return (
        <div>
          <p>To keep your original photo, click "NEXT"</p>
          <br/>
        </div>
      )
    } else {
...
class AddProjectForm extends Component {
  ...
  handleFormSubmit = event => {
    ...
    if (this.props.editing) {
      ...
      this.setState({ ownerID : this.props.user._id, open: true, canAdd: true, submitted: true}, () => {
          ...
          <div>
              ...
              <div className="row form-row">
                <div className="input-field col s12">
                  ...
                  onChange={this.handleInputChange}
                  name="link"
                  placeholder="Project URL (ex: https://www.myproject.com)"
                  type="text"
                  id="link"/>
        ...
        return (
          <div>
            ...
            <div className="row center">
              ...
              <UploadInstructions isEditing={this.props.editing}/>
                ...
                <div className="dropzone col s12 center">
                  ...
                  onChange={this.handleInputChange} 
                  style={{border:'dashed 2px #0087F7', padding: 35, margin: `auto`, height: 150, width: 150, borderRadius: `50%`, textAlign: `center`, backgroundImage: `url(${this.state.image})`, backgroundPosition: `center center`, backgroundRepeat: `no-repeat`, backgroundSize: `cover`}} 
                  name="image"
                  >
